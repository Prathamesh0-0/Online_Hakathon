...
let AiService = AiService_1 = class AiService {
    ...
    async answerQuestion(meetingTitle, transcriptLines, question, languageCode) {
    ...
    getMockQuestionAnswer(question, transcriptLines = []) {
    ...
    getMockActionItems(transcriptLines) {
        ...
        for (const line of transcriptLines) {
            ...
            if (cleanLine.includes('will') || cleanLine.includes('should') || cleanLine.includes('need to') || cleanLine.includes('task')) {
                ...
                if (cleanLine.includes('rahul'))
                    assigneeName = 'Rahul Sharma';
                else if (cleanLine.includes('priya'))
                    assigneeName = 'Priya Patel';
                else if (cleanLine.includes('aman'))
